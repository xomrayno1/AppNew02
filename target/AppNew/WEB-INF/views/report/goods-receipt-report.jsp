					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									<br />
									<c:url value="/goods-receipt/report/list" var="searchUrl"></c:url>
									  ...
									  <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Sản phẩm  <span class="required"> </span>
											 ...
											 <div class="col-md-6 col-sm-6 ">
									 		 	 ...
									 		 	 <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="name"> Tháng  <span class="required"> </span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											 	 
												 	<form:select path="month" cssClass="form-control">
															<form:option value="" >Tất cả</form:option>
															<c:forEach items="${lstMonth}" var="item"  varStatus="i">
																<form:option value="${i.index +1}">${item}</form:option>
															</c:forEach>
													</form:select>
											</div>
...
<script type="text/javascript">
	function gotoPage(page){
		$("#searchForm").attr('action',"<c:url value='/goods-receipt/report/list//'/>"+page);
		$("#searchForm").submit();
	}
	...
	$(document).ready(function(){
		$('#reportReceipt').parents("li").addClass('active').siblings().removeClass("active");
		$('#reportReceipt').addClass('current-page').siblings().removeClass("current-page");
		$('#reportReceipt').parents().show();
	});
